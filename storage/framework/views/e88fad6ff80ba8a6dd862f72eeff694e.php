        ...
        <footer class="s-footer">
            <div class="row s-footer__content">
                <div class="column xl-6 lg-6 md-12 s-footer__block s-footer__about">
                    <h3>Tentang Evelyn</h3>
                    <p>
                        Saya adalah mahasiswa informatika di Universitas Bengkulu 
                        yang fokus belajar dan mendalami pemrograman, terutama dengan Laravel. 
                        Selain itu, saya aktif di himpunan mahasiswa sebagai kepala bidang minat 
                        dan bakat. Saya senang belajar hal baru di bidang teknologi dan terus 
                        berusaha mengembangkan diri untuk sukses di masa depan.
                    </p>
                </div>
            ...
            <div class="row s-footer__bottom">
                <div class="column xl-6 lg-12">
                    <ul class="s-footer__social social-list">
                        <li>
                            <a href="https://www.facebook.com/ARIOSevelyn97?mibextid=LQQJ4d" target="_blank">
                        ...
                        <li>
                            <a href="https://twitter.com/evelyn" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                                    <path
                        ...
                        <li>
                            <a href="https://www.instagram.com/evelyn.aritonang?igsh=aTBja3BzZ3d4djhq&utm_source=qr" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                                    <path
                ...
                <div class="ss-go-top">
                    <a class="smoothscroll" title="Back to Top" href="#top">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36"
                            ...
                            https://atomicons.com/license/ (Icons: CC BY 4.0) Copyright 2021 Atomicons --&gt;<polyline
                                points="17 11 12 6 7 11"></polyline>
...
<?php /**PATH E:\laragon\www\tugasPBKK1\resources\views/app.blade.php ENDPATH**/ ?>